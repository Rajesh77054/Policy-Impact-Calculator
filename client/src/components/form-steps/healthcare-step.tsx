...
export default function HealthcareStep({ formData, onComplete }: HealthcareStepProps) {
  ...
  const handleSubmit = () => {
    ...
    onComplete({ 
      ...
      hasHSA: (insuranceType === "employer" || insuranceType === "marketplace") ? hasHSA : undefined
    });
  };
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={option.value}>
                  ...
                  {/* HSA Eligibility Question - Show directly below employer or marketplace options */}
                  {insuranceType === option.value && (option.value === "employer" || option.value === "marketplace") && (
                        ...
                        <label className="flex items-center space-x-2 cursor-pointer">
                          ...
                          <span className="text-sm text-slate-700">
                            {option.value === "employer" 
                              ...
                              : "My marketplace plan is HSA-eligible (High Deductible Health Plan)"
                            }
                          </span>
                        </label>
                      </div>
