                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-medium text-blue-900">
                        ${Math.round(Math.abs(results.annualTaxImpact) * 0.7).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-blue-700">FICA Taxes</span>
                      <span className="font-medium text-blue-900">
                        ${Math.round(Math.abs(results.annualTaxImpact) * 0.3).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-xs">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <span className="text-blue-700">Federal Income Tax</span>
                      <span className="font-medium text-blue-900">
                        ${Math.round(Math.abs(results.annualTaxImpact) * 0.65).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-blue-700">FICA Taxes</span>
                      <span className="font-medium text-blue-900">
                        ${Math.round(Math.abs(results.annualTaxImpact) * 0.25).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-blue-700">State Income Tax</span>
                  ...
                  <div className="mt-3 pt-2 border-t border-blue-200">
                    <div className="flex justify-between text-sm">
                      <span className="font-medium text-blue-800">Total Annual Tax</span>
                      <span className="font-bold text-blue-900">
                        ${Math.round(Math.abs(results.annualTaxImpact) * 0.9).toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>
